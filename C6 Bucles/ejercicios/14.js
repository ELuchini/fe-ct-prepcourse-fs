function operadoresLogicos(num1, num2, num3) {
  ...
  if (num1===num2 && num2===num3){
    if (num1===0){ //Si los tres son 0.
      return "Error";
    }
  } else if (num1>num2&&num1>num3){ //Si el num 1 es mayor a todos.
    return "Numero 1 es mayor y positivo";
  } else if (num1<0||num2<0||num3<0){ //si alguno es negativo.
    return "Hay negativos";
  } else if (num3>num1 && num3>num2){ //num 3 es mayor a los demás.
    return num3+1;
  } else {
    return false;
  }
